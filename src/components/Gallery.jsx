        ...
        >
            ...
            <div className="w-full max-w-[1500px] mx-auto px-6 sm:px-10 lg:px-14 relative z-10 flex flex-col">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-start relative">
                    ...
                    <div className="lg:col-span-7 flex flex-col gap-6 lg:gap-1 relative z-20">
                        {CELEBRITIES.map((celeb, idx) => (
                            ...
                            >
                                {/* Desktop List Item */}
                                <div className="hidden lg:flex items-center gap-6 py-6 cursor-pointer transition-all duration-500 hover:pl-6">
                                    ...
                                    <h3 className={`font-display text-5xl xl:text-7xl tracking-tight uppercase whitespace-nowrap transition-colors duration-500 ${hoveredCeleb?.id === celeb.id ? 'text-[var(--ink)]' : 'text-[var(--muted)]'}`}>
                                        {celeb.celebrity}
                                    </h3>
                                </div>
                    ...
                    {/* Right: The Floating Image (Desktop Only) */}
                    <div className="hidden lg:block lg:col-span-5 relative lg:sticky lg:top-[15vh]">
