...
const IVORY_PRODUCTS = [
    {
        ...
        tag: "Couture",
        front: WARDROBE_DATA["kurta-sets"].looks[0]?.gallery[1] || WARDROBE_DATA["kurta-sets"].looks[0]?.coverImg,
        back: WARDROBE_DATA["kurta-sets"].looks[0]?.gallery[2] || WARDROBE_DATA["kurta-sets"].looks[0]?.coverImg,
    },
    {
        id: "p2",
